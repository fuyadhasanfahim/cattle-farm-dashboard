...
export default function SalesDetailsPage() {
    const { id } = useParams();
    const [data, setData] = useState<ISale | null>(null);
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(
                    `/api/expense/sale/get-sale?id=${id}`
                );
    ...
    const handleDelete = async () => {
        try {
            const response = await fetch(
                `/api/expense/sale/delete-sale?id=${id}`,
                {
                    method: 'DELETE',
                }
            );
            ...
            <Card className="w-full max-w-4xl mx-auto">
                ...
                <CardContent>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {renderDetailItem(
                                    ...
                                    'Purchase Date',
                                    format(new Date(data.salesDate), 'PP')
                                )}
                            </div>
                        </div>
                    ...
                    <div className="mt-6 flex space-x-4">
                        <Link href={`/expense/update-sale/${id}`}>
                            <Button variant="outline">Edit Sale</Button>
                        </Link>
                        <AlertDialog>
