    ...
    const onSubmit = async (data: IBreeding) => {
        try {
            ...
            if (!response.ok) {
                ...
                toast.success(
                    'Breeding added successfully. Redirecting to /breeding!'
                );
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 items-center gap-6">
                            <MyCalender
                                ...
                                placeholder="Enter approximate birthdate"
                            />
                        </div>
